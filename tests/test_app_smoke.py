...
def test_package_version_is_defined() -> None:
    assert __version__ == "0.0.85"
    assert __display_version__ == "0.0.85"
...
def test_main_window_builds_mvp_shell(qapp) -> None:
    ...
    assert window.windowTitle() == "myLastFmPlayer v0.0.85"
...
def test_main_prints_version_at_startup(monkeypatch, capsys) -> None:
    ...
    assert capsys.readouterr().out == "myLastFmPlayer 0.0.85\n"
