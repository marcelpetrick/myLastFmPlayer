...
- Python package metadata normalizes two-digit versions such as `00.00.12` to `0.0.12` for built wheel filenames. The app-facing version keeps the requested two-digit format, but release tooling should make this distinction explicit.
