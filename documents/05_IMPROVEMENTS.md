...
- 25. Bug: on a fresh start with zero downloaded tracks, YouTube fetching does not work. The app says 150 tracks were downloaded, but nothing moves. Cross-checking track-model entries against existing files might make this easier to diagnose.
...
- 8. Consider switching from the widget-based UI to QML. Reassess whether this still has benefits after the theme work.
