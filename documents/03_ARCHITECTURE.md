...
This document describes the workflow implemented in the application as of version `00.00.20`. It focuses on how a Last.fm username such as `first` is fetched, stored, and shown in the UI.
