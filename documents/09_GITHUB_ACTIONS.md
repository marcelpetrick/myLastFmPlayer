...
- `version`: required version without the leading `v`, for example `0.0.65`.
...
6. Enter the exact version, for example `0.0.65`.
...
- The release tag is `v<version>`, for example `v0.0.65`.
